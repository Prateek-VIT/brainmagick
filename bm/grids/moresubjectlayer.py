...
def explorer(launcher):
    ...
    launcher.bind_({'model': 'clip_conv', 'optim.batch_size': 16,'override_n_subjects_model':27})
    ...
    with launcher.job_array():
        ...
        sub = [launcher.bind({'dset.selections': [initdset], 'override_n_subjects_model':27}, seed=initseed)]
